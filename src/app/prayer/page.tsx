    ...
    <div className={`min-h-screen flex flex-col ${isDarkMode ? "bg-gray-900 text-white" : "bg-white text-gray-800"}`}>
      ...
      <div className="max-w-4xl mx-auto w-full flex-1 flex flex-col px-4 py-8">        
        <div className="w-full">
          {/* Scripture Banner */}
          <div className={`${isDarkMode ? "bg-gray-800" : "bg-purple-50"} p-6 rounded-lg mb-10 text-center border-l-4 border-purple-700`}>
          ...
          {/* Success Message */}
          {submitSuccess && (
            <div className={`${isDarkMode ? "bg-gray-800 border-purple-600" : "bg-purple-50 border-purple-500"} border-l-4 p-4 mb-6 rounded`}>
              <div className="flex">
                <div className="ml-3">
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  type="text"
                  id="name"
                  className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-800 ${
                    isDarkMode
              ...
              <div className="mb-6">
                ...
                <textarea
                  id="request"
                  className={`w-full p-3 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-800 resize-none h-32 ${
                    isDarkMode
                      ? "bg-gray-700 border-gray-600 text-gray-200"
                      : "bg-white border-gray-300 text-gray-800"
                  }`}
                ...
                <button
                  ...
                  className={`w-full py-3 rounded-lg font-medium transition-colors ${
                    isSubmitting
                      ...
                      : "bg-purple-900 hover:bg-purple-600 text-white"
                  }`}
                >
